...
public class LargeBusTest {
  ...
  public void setUp() {
    ...
    testBus2 = new LargeBusDecorator(1, new Line(10000, "testLine", "BUS",
    ...
    try {
      ...
      String strToCompare =
          "####Large Bus Info Start####" + System.lineSeparator()
              ...
              + "Name: passenger1" + System.lineSeparator()
  ...
  /**
   * Test the color for a large bus.
   */
  @Test
  public void testGetColor() {
    ...
    assertEquals(colorJsonObject, testBus.getColor());
  }

  /**
   * Test the transparent color for a large bus.
   */
  @Test
  public void testGetTransparentColor() {
    testBus.getLine().createIssue();
    JsonObject colorJsonObject = new JsonObject();
    colorJsonObject.addProperty("r", 239);
    colorJsonObject.addProperty("g", 130);
    colorJsonObject.addProperty("b", 238);
  ...
  /**
   * Test the color decorator for color on large bus.
   */
  @Test
  public void testColorDecorator() {
    ...
    colorJsonObject.addProperty("b", 238);
    colorJsonObject.addProperty("alpha", 255);
    assertEquals(colorJsonObject, testBus2.getColor());
  }

  /**
   * Test the color decorator for transparent color on large bus.
   */
  @Test
  public void testColorDecoratorTransparent() {
    testBus2.getLine().createIssue();
    JsonObject colorJsonObject = new JsonObject();
    colorJsonObject.addProperty("r", 239);
    colorJsonObject.addProperty("g", 130);
    colorJsonObject.addProperty("b", 238);
