...
public class DieselTrainTest {
  ...
  public void setUp() {
    ...
    testTrain2 = new DieselTrainDecorator(1,
        new Line(10000, "testLine", "TRAIN", testRouteOut, testRouteIn, new Issue()),
        3, 1.0);
  }
  ...
  /**
   * Test the color for a diesel train.
   */
  @Test
  ...
  /**
   * Test the transparent color for a diesel train.
   */
  @Test
  ...
  /**
   * Test the color decorator for color on diesel train.
   */
  @Test
  ...
  /**
   * Test the color decorator for transparent color on diesel train.
   */
  @Test
