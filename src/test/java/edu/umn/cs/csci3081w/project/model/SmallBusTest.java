...
public class SmallBusTest {
  ...
  public void setUp() {
    ...
    testBus2 = new SmallBusDecorator(1, new Line(10000, "testLine", "BUS",
  ...
  /**
   * Test the color for a small bus.
   */
  @Test
  ...
  /**
   * Test the transparent color for a small bus.
   */
  @Test
  ...
  /**
   * Test the color decorator for color on small bus.
   */
  @Test
  ...
  /**
   * Test the color decorator for transparent color on small bus.
   */
  @Test
