...
public class RandomPassengerGeneratorTest {
  ...
  @Test
  public void testGeneratePassengersNonDeterm() {
    testRandomPassengerGenerator.DETERMINISTIC = false;
    int randomPassenger = testRandomPassengerGenerator.generatePassengers();
    if (randomPassenger == 0) {
      assertEquals(0, randomPassenger);
    } else {
      assertEquals(1, randomPassenger);
    }
  }
